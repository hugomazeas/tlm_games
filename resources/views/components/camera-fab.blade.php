...
<div x-data="cameraFab()" x-cloak>
    ...
    >
        ...
        >
            ...
            <div x-show="debug" class="mt-3 w-full max-w-[min(92vmin,640px)] grid grid-cols-2 gap-x-4 gap-y-1 text-[15px] font-mono text-white/60 bg-white/5 rounded-lg px-3 py-2">
            ...
            <div
                ...
                class="mt-2 w-full max-w-[min(92vmin,640px)] text-[15px] font-mono text-red-300 bg-red-500/10 border border-red-400/20 rounded-lg px-3 py-2 break-words whitespace-pre-wrap"
