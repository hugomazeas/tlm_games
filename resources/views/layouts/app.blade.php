    ...
    <nav class="border-b border-white/10 bg-white/5 backdrop-blur" x-data="{ mobileOpen: false }">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
            ...
            <div class="hidden sm:flex items-center gap-6 text-sm font-medium">
                ...
                <a href="{{ url('/games/ping-pong/challenges') }}" class="text-white/70 hover:text-white transition {{ request()->is('games/ping-pong/challenges') ? 'text-white' : '' }}">Match of the hour</a>
        ...
        <div x-show="mobileOpen" x-cloak
            ...
            <div class="px-4 py-3 space-y-1">
                ...
                <a href="{{ url('/games/ping-pong/challenges') }}" class="block px-3 py-2.5 rounded-lg text-sm font-medium transition {{ request()->is('games/ping-pong/challenges') ? 'bg-white/10 text-white' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">Match of the hour</a>
